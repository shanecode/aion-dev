...
public class MoveToMeAll extends AdminCommand
{
    ...
    */
    ...
    public void executeCommand(Player admin, String[] params)
    {
        ...
        {
            PacketSendUtility.sendMessage(admin, "Usage //movetomeall < all | elyos | asmos >");
            return;
		}
        ...
        if (params[0].equals("all"))
        {
            ...
            {
            PacketSendUtility.sendMessage(admin, "Vous n'avez pas assez de droits pour exécuter cette commande");
            return;
            }
            ...
            while(players.hasNext())
            {
                ...
                PacketSendUtility.sendMessage(admin, "Joueur " + p.getName() + " téléporté.");
                PacketSendUtility.sendMessage(p, "Téléporté par " + admin.getName() + ".");
                }
            }
        }
