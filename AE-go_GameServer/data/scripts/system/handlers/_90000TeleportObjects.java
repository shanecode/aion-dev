...
public class _90000TeleportObjects extends QuestHandler
{
	...
	{
		super(questId);
		QuestEngine.getInstance().setNpcQuestData(700088).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(700177).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(700360).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(700177).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730075).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730074).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730073).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(700089).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730064).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(700183).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730077).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730078).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730076).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730047).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730051).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730045).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(700152).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730041).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(700150).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(730043).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(700153).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(203981).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(203982).addOnTalkEvent(questId);	
	}
		...
		if(env.getVisibleObject() instanceof Npc)
			...
			switch(targetId){
				...
				case 700088:{// Verteron -> Abyss (Elyos)
					...
					else if(player.getCommonData().getRace() == Race.ELYOS || player.getAccessLevel() >= 1)
				...
				case 730075:{//Abyss -> Heiron
					if(player.getCommonData().getRace() == Race.ELYOS || player.getAccessLevel() >= 1)
				...
				case 700089:{//Altgard -> Abyss
					...
					else if(player.getCommonData().getRace() == Race.ASMODIANS || player.getAccessLevel() >= 1)
				...
				case 730077:{//Abyss -> Morheim
					if(player.getCommonData().getRace() == Race.ASMODIANS || player.getAccessLevel() >= 1)
