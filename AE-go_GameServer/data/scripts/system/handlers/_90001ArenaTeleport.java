...
public class _90001ArenaTeleport extends QuestHandler
{
	...
	public _90001ArenaTeleport()
	{
		...
		//Pandemonium
		QuestEngine.getInstance().setNpcQuestData(204089).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(204087).addOnTalkEvent(questId);
		
		//Sanctum
		QuestEngine.getInstance().setNpcQuestData(203875).addOnTalkEvent(questId);
		QuestEngine.getInstance().setNpcQuestData(203764).addOnTalkEvent(questId);
	}
